...
sys_msg = SystemMessage(
    content=(
        ...
        "The user can specify the district or the municipality. Therefore, please ensure you check all the municipalities "
        "for all districts, if the user doesn't specifies the district."
